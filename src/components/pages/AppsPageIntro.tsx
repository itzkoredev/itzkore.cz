...
import { Code2, ArrowRight, Zap, Globe, Smartphone } from 'lucide-react';
import Link from 'next/link';
import { useEffect } from 'react';
import { useRouter } from 'next/navigation';

export default function AppsPageIntro() {
        ...
        <div className="flex-1 flex items-center justify-center px-6">
          <div className="max-w-5xl w-full">
            ...
            >
              ...
              >
                <div className="p-6 rounded-2xl bg-gradient-to-br from-violet-500 to-purple-600 shadow-2xl shadow-violet-500/50">
              ...
              >
                Crafting modern web & desktop applications with cutting-edge technologies
              </motion.p>
              ...
              >
                <a href="#projects">
                  <motion.button
                    className="group px-10 py-5 bg-gradient-to-r from-violet-500 to-purple-600 rounded-full text-lg font-semibold hover:shadow-2xl hover:shadow-violet-500/50 transition-all duration-300 flex items-center gap-3 mx-auto"
            ...
            >
              {[
                { icon: Globe, title: 'Web Apps', desc: 'Responsive & Modern' },
                { icon: Smartphone, title: 'Mobile First', desc: 'Cross-platform Ready' },
